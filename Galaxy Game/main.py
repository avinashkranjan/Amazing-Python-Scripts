...
class MainWidget(RelativeLayout):
    ...
    # SPEED_X = 3.0
    SPEED_X = 3.0  # speed of ship on x-axis
    current_speed_x = 0
    current_offset_x = 0
    ...
    def init_ship(self):
        with self.canvas:
            # Color(0, 0, 0)  # default
            # Color(0.05, 0.59, 0.72)  # color of ship(player)
            Color(0.86, 0.07, 0.23)  # color of ship(player)
            self.ship = Triangle()
    ...
    def init_tiles(self):
        with self.canvas:
            ...
            Color(0.11, 0.16, 0.31, 1)  # color of player-tile (ground)
