...
class Test:
    ...
    def __init__(self):
        ...
        pygame.init()
        self.image_open = pygame.image.load(os.path.abspath("/home/abhishek/Desktop/GITHUB/SWOC/Amazing-Python-Scripts/typing speed test/typing_speed.png"))
        self.image_open = pygame.transform.scale(
            self.image_open, (self.w, self.h))

        self.bg = pygame.image.load(os.path.abspath("/home/abhishek/Desktop/GITHUB/SWOC/Amazing-Python-Scripts/typing speed test/background.png"))
    ...
    def get_challenge(self):
        return random.choice(open(os.path.abspath("/home/abhishek/Desktop/GITHUB/SWOC/Amazing-Python-Scripts/typing speed test/sentences.txt")).read().split('\n'))
    ...
    def results_show(self, screen):
        if(not self.end):
            ...
            # Draw Icon image
            self.time_img = pygame.image.load(os.path.abspath("/home/abhishek/Desktop/GITHUB/SWOC/Amazing-Python-Scripts/typing speed test/icon.png"))
