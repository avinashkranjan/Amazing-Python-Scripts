...
welcome_chatbot = Label (frame_welcome , text = 'Designed by VARSHITH ' , font = "Helvetica 8 bold" , bg = c1 , fg = 'white')
...
label_sub = Label (frame_info ,text = "Enter Information" , bg = c1 , fg = "white" , font = 'Verdana 30')
label_sub.pack()
...
chatbot_name = Label (frame_info , text = 'Give a name to your Assistant : ' , bg = c1 , fg = c2 , font = 'Ariel 15')
...
option_2 = Label (frame_topic , text = 'Designed by VARSHITH' , font = 'Verdana 8' , bg = c1 , fg= 'white')
...
button = Button (bottom_frame , image = submit_img , font = 'Vardana 8 bold' , bg = c3 , command = submit )
button.place(x = 410 , y = 27)
                                   
entry = Text (bottom_frame , bg = c3 , fg = 'white' ,relief = "flat", height = '4'  , width ='45' , font  ='Verdana 10')
...
button_write = Button (bottom_frame , text = ' write here !' ,width=15,bg = 'black' ,fg = 'white' , font = 'Vardana 8' ,  command = write_file )
