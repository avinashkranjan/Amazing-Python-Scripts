...
message = tk.Label(window, text="Detection of Covid-19 Using X-Ray" ,bg="orange",fg="white"  ,width=50  ,height=3,font=('times', 30, 'italic bold underline')) 
...
lbl3 = tk.Label(window, text="Status of a Person : ",width=20  ,fg="red"  ,bg="green"  ,height=2 ,font=('times', 15, ' bold underline ')) 
...
takeImg = tk.Button(window, text="Click to load X-ray Images ", command=run_example ,fg="red"  ,bg="green"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
