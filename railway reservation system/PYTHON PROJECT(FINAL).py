...
mydb = mysql.connector.connect(
    host="localhost", user="root", password="root", database="railway")
...
def DisplayTrain():
    ...
    if ch == 1:
        ...
        Time_of_departure_from_source = input(
            "enter time of departure from source of train:")
        ...
        Time_of_arrival_at_destination = input(
            "enter time of arrival at destination of train:")
...
def RemoveBooking():
    PNR = int(
        input("Enter the PNR number of the customer whose ticket is to be cancelled:"))
    rl = (PNR,)
    try:
...
def UpdateCustomer():
    ...
    if ch == 1:
        CName = int(
            input("enter the name of the customer whose customer number is changed:"))
...
def UpdateTrain():
    ...
    if ch == 1:
        TName = input(
            "enter the name of the train whose train number is to be changed:")
        ...
        TNo = int(input("enter the train number of the train:"))
        Time_of_departure_from_source = input(
            "enter the new departure time of the train:")
        ...
        TNo = int(input("enter the train number of the train:"))
        Time_of_arrival_at_destination = input(
            "enter the new arrival time of the train:")
...
def RegisterTM():
    ...
    try:
        ...
        for y in res:
            print(
                y[0], " is your train manager ID please remember it as your login ID")
        return res
    except Exception as e:
        print(e)
